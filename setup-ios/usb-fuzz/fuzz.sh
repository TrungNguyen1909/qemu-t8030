...
AFL/afl-fuzz -m 16G -i - -o output_3 $@ \
qemu-t8030/build/qemu-system-aarch64 -s -M t8030,trustcache-filename=Firmware/038-44135-124.dmg.trustcache,ticket-filename=rootticket.der,boot-mode=enter_recovery,usbfuzz=1 \
