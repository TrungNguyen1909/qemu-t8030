...
qemu-t8030/build/qemu-system-aarch64 -s -M t8030,trustcache-filename=Firmware/038-44135-124.dmg.trustcache,ticket-filename=rootticket.der,boot-mode=enter_recovery,usbfuzz=true,usbfuzz-filename=usb_tcp_dump_0 \
...
-m 1G -icount 0 -serial mon:stdio \
